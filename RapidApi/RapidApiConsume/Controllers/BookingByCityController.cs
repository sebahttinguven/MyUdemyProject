        ...
        public async Task<IActionResult> Index(string cityId)
        {
            if (!String.IsNullOrEmpty(cityId))
            {
				...
				var request = new HttpRequestMessage
				{
					...
					RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v1/hotels/search?checkin_date=2023-11-24&dest_type=city&units=metric&checkout_date=2023-11-27&adults_number=2&order_by=popularity&dest_id={cityId}&filter_by_currency=EUR&locale=en-gb&room_number=1&children_number=2&children_ages=5%2C0&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&page_number=0&include_adjacency=true"),
