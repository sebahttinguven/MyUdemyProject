...
namespace HotelProject.WebUI.ValidationRules.GuestValidatonRules
{
    public class UpdateGuestValidator : AbstractValidator<UpdateGuestDto>
    {
        public UpdateGuestValidator()
        {
            ...
            RuleFor(x => x.Name).MaximumLength(20).WithMessage("Lütfen en az 3 karakter veri girişi yapınız");
            RuleFor(x => x.Surname).MaximumLength(30).WithMessage("Lütfen en az 3 karakter veri girişi yapınız");
            RuleFor(x => x.City).MaximumLength(20).WithMessage("Lütfen en az 3 karakter veri girişi yapınız");
        }
    }
}
